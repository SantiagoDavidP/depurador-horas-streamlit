...
class ReportGenerationMixin:
    def generate_consolidated_report(
        ...
        for idx, metrics in enumerate(sorted_metrics, start=1):
            ...
            sheet_df_map[sheet_name] = to_pandas_table(metrics.dataframe)
    ...
    def generate_single_consultant_report(
        ...
        self.postprocess_hide_empty_table_rows_preserve_footer(
            wb,
            {ws.title: to_pandas_table(metrics.dataframe)},
        )
